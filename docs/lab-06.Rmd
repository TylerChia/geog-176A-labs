...
building_gif = st_intersection(basin, building)
...
gifski::save_gif({
  for(i in 0:20) {
    ...
    plot(hillshade_sb, col = gray.colors(256, alpha = .5), main = paste(sum(building$flooded == 1), "Impacted Buildings,", i, "Foot Stage"), legend = F, box =F, axes = F)
