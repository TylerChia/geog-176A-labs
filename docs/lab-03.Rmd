...
filtered_distance_country <- cities2 %>% 
  ...
  slice(n = 1:5) %>% 
  st_drop_geometry() 
knitr::kable(filtered_distance_country, caption = "5 Cities Furthest from the US Border", col.names = c("City", "State", "Distance (km)"), align = "ccc")
```
...
filtered_distance <- cities1 %>% 
  ...
  slice(n = 1:5) %>% 
  st_drop_geometry() 
knitr::kable(filtered_distance, caption = "5 Cities Furthest from a State Border", col.names = c("City", "State", "Distance (km)"), align = "ccc")
```
...
filtered_distance_mex <- cities3 %>% 
  ...
  slice(n = 1:5) %>% 
  st_drop_geometry() 
knitr::kable(filtered_distance_mex, caption = "5 Cities Furthest from the Mexican Border", col.names = c("City", "State", "Distance (km)"), align = "ccc")
```
...
filtered_distance_canada <- cities4 %>% 
  ...
  slice(n = 1:5) %>% 
  st_drop_geometry() 
knitr::kable(filtered_distance_canada, caption = "5 Cities Furthest from the Canadian Border", col.names = c("City", "State", "Distance (km)"), align = "ccc")
```
